...
// I modified the isIntervalEqual function
const isIntervalEqual = function (a, b) {
        ...
        if (this.root === undefined) {
            ...
            if (node !== undefined) {
                ...
                for (var i = 0; i < node.records.length; i++) {
                    if (isIntervalEqual(node.records[i], record)) {
    ...
    IntervalTree.prototype.remove = function (record) {
        if (this.root === undefined) {
            ...
            if (node === undefined) {
                ...
                if (isIntervalEqual(node.records[0], record)) {
